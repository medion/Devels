...
<!-- header -->
	<header>
		<nav>
			<ul id="menu">
                            <li id="menu_active"><a href="http://devels.loc/"><?=$lang['header_home']?></a></li>
                            <li><a href="http://devels.loc/news"><?=$lang['header_news']?></a></li>
                            <li class="bg_none"><a href="/page/contacts"><?=$lang['header_contacts']?></a></li>
			</ul>
		</nav>
		<ul id="icon">
			<li><a href="#"><img src="http://devels.loc/images/icon1.jpg" alt=""></a></li>
			<li><a href="#"><img src="http://devels.loc/images/icon2.jpg" alt=""></a></li>
			<li><a href="#"><img src="http://devels.loc/images/icon3.jpg" alt=""></a></li>
			<li><a href="#"><img src="http://devels.loc/images/icon4.jpg" alt=""></a></li>
			<li><a href="#"><img src="http://devels.loc/images/icon5.jpg" alt=""></a></li>
		</ul>
	</header>
</div>
<div class="body1">
...
<!-- content -->
			<section id="content">
				<div class="wrapper marg_left1">
					<article class="col1">
                                                <h2><?=$data['title_'.$lng]?></h2>
													<?php
													print_r($data['text_'.$lng]);
													//print_r($_SESSION);
													?>
